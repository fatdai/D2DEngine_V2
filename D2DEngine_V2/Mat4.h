...
namespace D2D {
     ...
     * methods for post-multiplying by a matrix representing a scale, rotation, or
     *translation).
     *
     * In the case of repeated local transformations (i.e. rotate around the Z-axis
     *by 0.76 radians,
     * then translate by 2.1 along the X-axis, then ...), it is better to use the
     *Transform class
    ...
    public:
         ...
         *
         * The passed-in array is in column-major order, so the memory layout of the
         *array is as follows:
         *
         *     0   4   8   12
         *     1   5   9   13
         ...
         */
        static void createLookAt(const Vec3 &eyePosition, const Vec3 &targetPosition,
                                 const Vec3 &up, Mat4 *dst);
         ...
         * @param dst A matrix to store the result in.
         */
        static void createLookAt(float eyePositionX, float eyePositionY,
                                 float eyePositionZ, float targetCenterX,
                                 float targetCenterY, float targetCenterZ, float upX,
                                 float upY, float upZ, Mat4 *dst);
         ...
         * After the projection transformation, visible content has x- and
         *y-coordinates ranging from -1 to 1,
         * and a z-coordinate ranging from 0 to 1. To obtain the viewable area (in
         *world space) of a scene,
         * create a BoundingFrustum and pass the combined view and projection matrix
         *to the constructor.
         *
         ...
         * @param dst A matrix to store the result in.
         */
        static void createOrthographic(float width, float height, float zNearPlane,
         ...
         * @param dst A matrix to store the result in.
         */
        static void createOrthographicOffCenter(float left, float right, float bottom,
         ...
         *position.
         *
         * This method computes the facing direction of the billboard from the object
         *position
         * and camera position. When the object and camera positions are too close,
         *the matrix
         * will not be accurate. To avoid this problem, this method defaults to the
         *identity
         * rotation if the positions are too close. (See the other overload of
         *createBillboard
         * for an alternative approach).
         *
         * @param objectPosition The position of the object the billboard will rotate
         *around.
         ...
         * and camera position. When the object and camera positions are too close,
         *the matrix
         * will not be accurate. To avoid this problem, this method uses the specified
         *camera
         * forward vector if the positions are too close. (See the other overload of
         *createBillboard
         * for an alternative approach).
         *
         * @param objectPosition The position of the object the billboard will rotate
         ...
         * @param cameraPosition The position of the camera.
         * @param cameraUpVector The up vector of the camera.
         * @param cameraForwardVector The forward vector of the camera, used if the
        ...
        static void createBillboard(const Vec3 &objectPosition,
                                    ...
                                    const Vec3 &cameraForwardVector, Mat4 *dst);
        
        /**
         * Fills in an existing Mat4 so that it reflects the coordinate system about a
         *specified Plane.
         *
         ...
         * @param dst A matrix to store the result in.
         */
        static void createTranslation(float xTranslation, float yTranslation,
                                      float zTranslation, Mat4 *dst);
        ...
        /**
         * Adds a scalar value to each component of this matrix and stores the result
         *in dst.
         *
        ...
        /**
         * Multiplies the components of this matrix by a scalar and stores the result
         *in dst.
         *
         * @param scalar The scalar value.
         * @param dst A matrix to store the result in.
        ...
        /**
         * Multiplies the components of the specified matrix by a scalar and stores
         *the result in dst.
         *
         ...
         * @param m44 The fourth element of the fourth row.
         */
        void set(float m11, float m12, float m13, float m14, float m21, float m22,
                 float m23, float m24, float m31, float m32, float m33, float m34,
                 float m41, float m42, float m43, float m44);
        
        /**
         * Sets the values of this matrix to those in the specified column-major
         *array.
         *
         ...
         *
         * @param point The point to transform and also a vector to hold the result
         *in.
         */
         ...
         *
         * @param vector The vector to transform and also a vector to hold the result
         *in.
         */
