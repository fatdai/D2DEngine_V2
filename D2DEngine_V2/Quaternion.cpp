...
void Quaternion::createFromAxisAngle(const Vec3 &axis, float angle,
                                     Quaternion *dst) {
  assert(dst);
...
void Quaternion::slerp(const Quaternion &q1, const Quaternion &q2, float t,
                       Quaternion *dst) {
  assert(dst);
  slerp(q1.x, q1.y, q1.z, q1.w, q2.x, q2.y, q2.z, q2.w, t, &dst->x, &dst->y,
        &dst->z, &dst->w);
}

void Quaternion::squad(const Quaternion &q1, const Quaternion &q2,
...
void Quaternion::slerp(float q1x, float q1y, float q1z, float q1w, float q2x,
...
void Quaternion::slerpForSquad(const Quaternion &q1, const Quaternion &q2,
                               float t, Quaternion *dst) {
  assert(dst);
